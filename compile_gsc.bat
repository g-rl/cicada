...
"%ACTS%" gscc "menu.gsc" -o final\13645532f846e433 -g mwiii --name "script_13645532f846e433.gsc" --crc "1fa99f98" --namespace "namespace_eb31a7ea746bf7d0"
::"%ACTS%" gscc "funcs.gsc" -o final\2B79931B08683E0A -g mwiii --name "script_2b79931b08683e0a.gsc" --crc "a325beb1" --namespace "namespace_152f3860b54f75e5"
